        ...
        <div className='px-[10%]'>
            <div className="relative">
                ...
                <div className="w-full  text-white text-center text-sm flex flex-col items-center absolute top-0">
                    ...
                    <h2 className="text-[#abadaf] mt-5 text-xl w-5/12">Exploring the solana ecosystem by uncovering platforms, high-caliber bots, powerful tools, emerging memecoins, and comprehensive learning resources</h2>
                </div>
            </div>
