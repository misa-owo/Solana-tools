        ...
        },
        {
            ...
            details: {
                ...
                paragraph: [
                    ...
                    "⚡ Pro Tip: Use the Menu button at the bottom of the Telegram screen for quick access to all of the options the Trojan Trading Bot offers."
                ]
            }
        },
        {
            ...
            details: {
                ...
                paragraph: [
                    ...
                    "💡 How to Withdraw SOL: Select the \"Withdraw\" tab, choose \"Solana,\" and follow the on-screen instructions for a seamless withdrawal process."
                ]
            }
        },
        {
            ...
            details: {
                ...
                paragraph: [
                    ...
                    "5. You’ll receive a notification from the bot once the transaction is completed.",
                    "🔍 Quick Tip: Use token details for better trading decisions."
                ]
            }
        },
        {
